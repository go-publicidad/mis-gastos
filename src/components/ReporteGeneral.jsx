...
import { Calendar, X, BarChart2, PieChart, CheckCircle2, ChevronDown } from "lucide-react";
import { formatMoney, formatCatName } from "../utils";

export default function ReporteGeneral({ c, s, isDark, gastos, categoriasBase, categoriasExtra, categorias }) {
