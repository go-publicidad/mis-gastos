...
export default function PantallaDatos({ 
  c, s, userName, setUserName, usuario, guardarPerfil, saving, 
  cerrarPantalla, setProfileScreen, userInitials, isClosing 
}) {
  return (
    <div style={{ 
      position: "fixed", 
      ...
      overflowY: "auto", 
      overflowX: "hidden",
      // 👇 AQUÍ ESTÁ LA ANIMACIÓN CORREGIDA 👇
      animation: isClosing === 'datos' 
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <input style={{ ...s.input, opacity: 0.6 }} value={usuario?.email || "Cargando..."} disabled />
        <div style={{ fontSize: 12, color: c.muted, marginTop: 8, fontWeight: 400 }}>El correo está enlazado a tu cuenta de acceso.</div>
      </div>

      <button style={s.btnPrimary} onClick={guardarPerfil} disabled={saving}>
