...
// AQUÍ ESTÁ EL IMPORT DEL QUE HABLABA: Traemos los 3 íconos
...
export default function TabPresupuesto({
    ...
    gastos, categorias, setCatPresupSelec, setShowHistorial, setShowPresupAnual // <--- AQUÍ ESTAMOS RECIBIENDO LA PROP
}) {
    ...
    // ==========================================
    // PANTALLA: EMPTY STATE (SIN PRESUPUESTO)
    // ==========================================
    if (!presupuestoActual) {
        return (
            <div style={s.section}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8, marginTop: 8 }}>
                    <button onClick={() => setShowPresupAnual(true)} style={{ background: "none", border: "none", color: c.brandBlue, fontWeight: 700, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", gap: 6, fontFamily: "inherit" }}>
                        <BarChart2 size={16} /> Vista Anual
                    </button>
    ...
    // ==========================================
    // PANTALLA: DASHBOARD VISUAL (CON DATOS)
    // ==========================================
