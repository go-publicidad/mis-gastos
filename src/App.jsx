...
export default function App() {
  ...
  if (!loaded) return (
    <div style={{ background: "#0A0A0A", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 12 }}>
      ...
      <style>{`@keyframes spin { to { transform: rotate(360deg) } } html,body{background:#0A0A0A!important;margin:0;padding:0;overscroll-behavior-y:none} #root{background:#0A0A0A;min-height:100vh}`}</style>
  ...
  return (
    <div style={s.app}>
      <style>{`html,body{background:#0A0A0A!important;margin:0;padding:0;overscroll-behavior-y:none}#root{background:#0A0A0A;min-height:100vh}`}</style>
